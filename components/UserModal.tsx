...
import { X, MapPin, Link as LinkIcon, Building, Github, Calendar, Terminal } from 'lucide-react';
        ...
        <div className="px-8 pb-8">
          ...
          <div className="grid grid-cols-4 gap-2 mb-8 bg-dark-bg p-4 border border-dark-border">
            ...
            <div className="text-center border-l border-dark-border">
              ...
              <div className="text-[9px] text-dark-text uppercase font-medium mt-1">Contributions</div>
            </div>
          </div>
